...
export default class Rate extends Component<Props, State> {
    state: State;
    classMap: classMap;
    colorMap: colorMap;
    ...
    hasClass(target: HTMLInputElement, classname: string) {
        return target.classList.contains(classname)
    }

    setCurrentValue(e: any, value: number): any {
    ...
    getValueFromMap(value: number, map: colorAndclassMap): string {
